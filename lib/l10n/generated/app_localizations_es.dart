...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get keyboardSettingsTitle => 'Burbuja y teclado';

  @override
  String get keyboardSettingsSectionStatus => 'Bubble y permisos';

  @override
  String get keyboardSettingsSectionBehavior => 'Comportamiento del bubble';
  ...
  @override
  String get imeStatusActive => 'Activo — escribiendo con TransKey';

  @override
  String get imeStatusEnabledNotSelected =>
      'Habilitado. Toca para cambiar a TransKey.';

  @override
  String get imeStatusNotEnabled =>
      'No habilitado. Toca para activarlo en Ajustes.';
  ...
  @override
  String get errorEmailAlreadyExists => 'Este correo ya está registrado';

  @override
  String get errorWrongPassword => 'La contraseña actual es incorrecta';
  ...
  @override
  String get setupStep2TitleAndroid => 'Burbuja activada';
  ...
  String get setupStep3DescAndroid =>
      'El botón TransKey ya está en tu pantalla. Copia cualquier texto, toca el botón, elige una acción - verás el resultado enseguida sin salir de tu app.';
  ...
  String get setupStep4DescAndroid =>
      'Copia texto en cualquier app → toca el botón TransKey → elige Traducir, Responder u otra función → toca en cualquier parte para cerrar cuando termines.';
  ...
  @override
  String get guidePlanCompareTitle => 'Funciones por plan';

  @override
  String get guidePlanFreeLabel => 'Gratis';

  @override
  String get guidePlanPaidLabel => 'De pago';

  @override
  String get guidePlanFreeItems => 'Traducir\nLista de palabras';
  ...
  @override
  String get guideSectionFree => 'Funciones gratuitas';

  @override
  String get guideSectionPaid => 'Funciones de pago';

  @override
  String get guideFreeBadge => 'Gratis';

  @override
  String get guidePaidBadge => 'De pago';

  @override
  String get guideInputPaidBadge => 'De pago';

  @override
  String get guideFeatureGlossary => 'Lista de palabras';

  @override
  String get guideFeatureGlossarySubtitle =>
      'Guarda traducciones personalizadas que TransKey siempre usará primero';

  @override
  String get guideInputGlossaryTitle => 'Desde la pestaña Lista de palabras';

  @override
  String get guideInputGlossaryDesc =>
      'Abre la pestaña Lista de palabras y añade pares. TransKey usará tus traducciones primero al encontrar esas palabras.';

  @override
  String get guideFeatureCamera => 'Escaneo con cámara';

  @override
  String get guideFeatureCameraSubtitle =>
      'Fotografía texto para traducir - carteles, menús, libros';

  @override
  String get guideInputCameraTitle => 'Toca el botón de cámara';

  @override
  String get guideInputCameraDesc =>
      'Toca el icono de cámara en la parte superior de la pantalla principal. Apunta al texto, toma la foto y ve la traducción sobre la imagen.';

  @override
  String get guideInputVoiceTitle => 'Habla para introducir texto';

  @override
  String get guideInputVoiceDesc =>
      'En la pantalla principal, toca el micrófono y habla. Tus palabras se convierten en texto y se traducen automáticamente.';
  ...
  String get guideIntroBody =>
      'Cada función solo lee el texto cuando haces algo a propósito — copiar texto, escanear la pantalla, seleccionar un área, usar el botón Compartir del sistema, o tocar TransKey desde el menú de selección.';
  ...
  @override
  String get guideInputTypeTitle => 'Escribe tu propio texto';

  @override
  String get guideInputTypeDesc =>
      'Toca la burbuja → Escribe tu propio texto, luego elige la acción que quieras.';

  @override
  String guideInputKeyboardTitle(String feature) {
    return 'Desde el Teclado TransKey → $feature';
  }

  @override
  String guideInputKeyboardDesc(String feature) {
    return 'Cambia al Teclado TransKey en cualquier app, escribe tu mensaje, luego toca el chip $feature sobre las teclas.';
  }
  ...
  @override
  String get cameraRetranslate => 'Traducir otra vez';
  ...
  @override
  String get cameraConfidenceUnreliable => 'No fiable';

  @override
  String get cameraHoldSteady => 'Mantén firme';

  @override
  String get cameraPausedTitle => 'Cámara en pausa';

  @override
  String get cameraPausedTapToResume => 'Toca para reanudar';

  @override
  String get cameraWaitFocus => 'Espera el enfoque, mantén firme';

  @override
  String get cameraCopyTranslation => 'Copiar traducción';

  @override
  String get cameraCopyOriginal => 'Copiar original';

  @override
  String get cameraRetryBlock => 'Traducir de nuevo';

  @override
  String get cameraSaveBlock => 'Guardar en el cuaderno';

  @override
  String get cameraSavingPhrasebook => 'Guardando…';

  @override
  String get cameraBlockRetrying => 'Traduciendo de nuevo…';
  ...
  @override
  String get cameraSaveNoteLabel => 'Añadir nota (opcional)';

  @override
  String get cameraSaveNoteHint => 'p. ej., cerca del hotel, muy picante';

  @override
  String get cameraSaveSkipNote => 'Omitir';
  ...
  @override
  String get cameraShareSubject => 'Traducido con TransKey';

  @override
  String get cameraShareFailed => 'No se pudo compartir. Inténtalo de nuevo.';
  ...
  @override
  String get cameraSettingsFontScale => 'Tamaño del texto';

  @override
  String get cameraSettingsFontScaleHint =>
      'Aumentar el texto traducido. El texto puede salirse del globo de diálogo.';
  ...
  @override
  String get cameraSceneManga => 'Cómic';
  ...
  String get cameraExplainStaleBadge =>
      'Guardado sin conexión — puede estar desactualizado';
  ...
  String get upgradeSubscriptionTerms =>
      'Las suscripciones se renuevan automáticamente a menos que se cancelen. El pago se carga a tu cuenta de App Store o Google Play al confirmar la compra y se renueva a menos que canceles al menos 24 horas antes de que termine el período actual. Puedes gestionar o cancelar en cualquier momento en los ajustes de tu cuenta de la tienda.';

  @override
  String get subscriptionManageButton => 'Gestionar suscripción';

  @override
  String get subscriptionStoreManaged =>
      'Tu suscripción se gestiona a través de App Store o Google Play. Toca abajo para verla, cambiarla o cancelarla.';

  @override
  String get homeTagline => 'Traducir · Resumir · Explicar';

  @override
  String get historyEmptyTagline => 'Tus traducciones aparecerán aquí';

  @override
  String get glossaryEmptyTagline =>
      'Guarda términos que usas a menudo para nombres exactos';

  @override
  String get quotaTodayUsage => 'Uso de hoy';

  @override
  String get quotaWallTitle => 'Has agotado tu cuota de hoy';

  @override
  String get quotaWallBody =>
      'Mira un anuncio corto para obtener más traducciones ahora, o mejora tu plan para uso ilimitado.';

  @override
  String get quotaWallWatchAdCta => 'Ver anuncio para más traducciones';

  @override
  String get quotaWallUpgradeCta => 'Mejorar para uso ilimitado';

  @override
  String get quotaWallCloseCta => 'Más tarde';

  @override
  String get guideScreenshotTipTitle => 'Captura de pantalla sin la burbuja';
